...
open class LVXinScanViewController: UIViewController, UIImagePickerControllerDelegate, UINavigationControllerDelegate {
   ...
   open var isOpenInterestRect = false
    ...
    open func handleCodeResult(arrayResult:[LBXScanResult])
    {
        ...
        User.RenewFilterTime(mac: ProductInfo.getCurrDeviceMac(), type: (OznerManager.instance.currentDevice?.deviceInfo.deviceType)!, code: result.strScanned!, success: {
            ...
            self.showMsg(title: "", message: error.localizedDescription)
        })
