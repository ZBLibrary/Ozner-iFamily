...
class WebShopController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
//        urlstr = GoUrlBefore(str: "http://www.oznerwater.com/lktnew/wap/mall/mallHomePage.aspx")
        urlstr = "http://www.oznerwater.com/lktnew/wap/app/Oauth2.aspx?mobile=" + mobile! + "&UserTalkCode=" + UserTalkCode! + "&Language=" + Language + "&Area=" + Area + "&goUrl=" + "http://www.oznerwater.com/lktnew/wap/mall/mallHomePage.aspx"
//        print(urlstr!)
//
//        let webView=UIWebView(frame: CGRect(x: 0, y: -20, width:  width_screen, height:height_screen-25))
